...
public class EditCompteActivity extends AppCompatActivity {
    ...
    private Spinner editType;  // Change EditText to Spinner
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editType = findViewById(R.id.editType);  // Initialize Spinner
    ...
    private void saveCompte() {
        ...
        String type = editType.getSelectedItem().toString();  // Get the selected type from Spinner
